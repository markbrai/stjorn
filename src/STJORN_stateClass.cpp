...
void Stjorn::setFXDly(int fx, bool state)
{
    m_fx_dly[fx] = state;
}

void Stjorn::setFXVrb(int fx, bool state)
{
    m_fx_vrb[fx] = state;
}

void Stjorn::setFXMod(int fx, bool state)
{
    m_fx_mod[fx] = state;
}
...
bool Stjorn::fx_mod(int fx)
{
    return m_fx_mod[fx];
}

bool Stjorn::fx_dly(int fx)
{
    return m_fx_dly[fx];
}
